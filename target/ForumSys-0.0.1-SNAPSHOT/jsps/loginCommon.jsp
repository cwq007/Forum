			...
			<div class="col-sm-offset-3 col-sm-6">
				<div class="ibox">
					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="loginForm" method="post" action="<%=basePath%>user/user_login.action">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="loginPass" name="loginPass" class="form-control" type="text"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<img src="${basePaht}verifyCode.jsp" alt="验证码" onclick="this.src=this.src+'?'+new Date()"/>
                                </div>
                            </div>
                            <div class="form-group">
