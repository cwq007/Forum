		...
		<div id="page-wrapper" class="gray-bg"> 
			...
			<div id="contentContainer" class="tabs-container">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="${basePath}user/user_profile.action?part=usersubscribe">用户订阅</a></li>
				</ul>  
				<div class="tab-content">
					<div id="usersubscribe" class="tab-pane active">
						<div class="panel-body">
							
							<div class="row">
				                <div class="contact-box">
		                        	<s:if test="#session.usersubscribes.size == 0">
		                        		<div class="col-sm-12">你还没有订阅任何主题</div>
		                        	</s:if>
		                        	<s:else>
				                        <s:iterator var="usersubscribe" value="#session.usersubscribes">
								            <div class="col-sm-4">
						                        <div class="col-sm-4">
